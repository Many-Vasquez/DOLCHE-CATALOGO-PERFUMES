...
CATALOGO_MAESTRO_GPM = [
    ...
    {"Nombre": "Chanel Coco Mademoiselle 3.4oz Eau de Parfum", "Precio Venta MXN": 3598.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1543422967-8854067965fa?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Club de Nuit Woman 3.6oz Eau de Parfum By Armaf", "Precio Venta MXN": 1150.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1523293182086-7651a899d37f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Dior J'adore 3.4oz Eau de Parfum", "Precio Venta MXN": 3238.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Dolce & Gabbana Light Blue 3.3oz Edt", "Precio Venta MXN": 1978.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=400&q=80"},
    ...
    {"Nombre": "Gucci Flora Gorgeous Orchid 3.3oz Eau de Parfum", "Precio Venta MXN": 2482.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1523293182086-7651a899d37f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Jean Paul Gaultier La Belle Rosea .2oz Mini edp for Women", "Precio Venta MXN": 574.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1595425970377-c9703cf48b6d?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Jean Paul Gaultier Scandal 2.7oz Edp", "Precio Venta MXN": 2518.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Lancome Idole 3.4oz Eau de Parfum", "Precio Venta MXN": 2698.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=400&q=80"},
    ...
    {"Nombre": "Mugler Angel 1.7oz Eau de Parfum", "Precio Venta MXN": 2518.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Narciso Rodriguez For Her 3.3oz Edt", "Precio Venta MXN": 2338.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Orientica Royal Amber 2.7oz Eau de Parfum", "Precio Venta MXN": 1798.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1583445013765-46c20c4a6772?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Prada Paradoxe 3.3oz Eau de Parfum", "Precio Venta MXN": 2698.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1523293182086-7651a899d37f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Prada Paradoxe Intense .23oz Mini Eau de Parfum", "Precio Venta MXN": 934.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Sol de Janeiro Cheirosa 62 8.1oz Mist", "Precio Venta MXN": 934.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Sol de Janeiro Cheirosa 68 8.1oz Mist", "Precio Venta MXN": 934.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1595425970377-c9703cf48b6d?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Valentino Born In Roma Donna 3.4oz Edp", "Precio Venta MXN": 2878.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Versace Bright Crystal 3.0oz Eau de Toilette", "Precio Venta MXN": 1798.20, "Seccion": "Dama", "Imagen": "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80"},
    ...
    {"Nombre": "Acqua Di Gio Parfum 2.5oz Parfum By Giorgio Armani", "Precio Venta MXN": 2338.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Asad 3.4oz Eau de Parfum By Lattafa", "Precio Venta MXN": 934.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Azzaro Most Wanted Parfum 3.4oz", "Precio Venta MXN": 2698.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Bad Boy .27oz Mini Edt By Carolina Herrera", "Precio Venta MXN": 826.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Bad Boy Cobalt .27oz Mini Edp By Carolina Herrera", "Precio Venta MXN": 826.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1543422967-8854067965fa?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Bleu de Chanel 3.4oz Eau de Parfum", "Precio Venta MXN": 3598.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1595425970377-c9703cf48b6d?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Club de Nuit Intense Man 3.6oz Edp By Armaf", "Precio Venta MXN": 1258.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1523293182086-7651a899d37f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Dior Sauvage 3.4oz Eau de Toilette", "Precio Venta MXN": 2878.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Dior Sauvage Elixir 2.0oz", "Precio Venta MXN": 3958.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Dolce & Gabbana The One For Men 3.3oz Edt", "Precio Venta MXN": 1978.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1583445013765-46c20c4a6772?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Eros Energy 3.4oz Eau de Parfum By Versace", "Precio Venta MXN": 2338.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Eros Flame 3.4oz Eau de Parfum By Versace", "Precio Venta MXN": 2158.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Hermes Terre D'Hermes 3.4oz Edt", "Precio Venta MXN": 2518.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1543422967-8854067965fa?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Jean Paul Gaultier Le Male Le Parfum 4.2oz", "Precio Venta MXN": 2698.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1523293182086-7651a899d37f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Khamrah Qahwa 3.4oz Eau de Parfum By Lattafa", "Precio Venta MXN": 1150.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Montblanc Explorer 3.4oz Edp", "Precio Venta MXN": 1438.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Paco Rabanne 1 Million 3.4oz Eau de Toilette", "Precio Venta MXN": 2338.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Paco Rabanne Invictus 3.4oz Eau de Toilette", "Precio Venta MXN": 2338.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1595425970377-c9703cf48b6d?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Prada Luna Rossa Black 3.4oz Edp", "Precio Venta MXN": 2698.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Tom Ford Noir Extreme 3.4oz Edp", "Precio Venta MXN": 4138.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1583445013765-46c20c4a6772?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Tom Ford Ombre Leather 3.4oz Eau de Parfum", "Precio Venta MXN": 3958.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1523293182086-7651a899d37f?auto=format&fit=crop&w=400&q=80"},
    {"Nombre": "Valentino Born In Roma Uomo 3.4oz Edt", "Precio Venta MXN": 2878.20, "Seccion": "Caballero", "Imagen": "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80"},
    ...
    {"Nombre": "Spider-Man Marvel Eau de Toilette for Kids", "Precio Venta MXN": 640.00, "Seccion": "Kids", "Imagen": "https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80"},
